...
| :--- | :--- | :--- | :--- |
| **🐙 GitHub Repository** | [https://github.com/Livesh28/RAG_DOCUMENT](https://github.com/Dinesh-05-G/RAG) | `Main Branch (Up to date)` | Complete source code, Docker configs, and setup scripts |
